// SISTEMA PROMPT SYNC - VERSÃO NATIVA (SEM DEPENDÊNCIAS EXTERNAS)
// Usa fetch nativo do Node.js (versão 18+) e readline nativo
...
async function fazerDenuncia(): Promise<void> {
  ...
  try {
    ...
    // Enviar para API usando fetch nativo
...
async function main(): Promise<void> {
  console.log('🚀 Iniciando Sistema Prompt Sync TypeScript (Versão Nativa)...');
